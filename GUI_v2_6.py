...
class ComparisonSettingsWindow(QWidget):
    ...
    def run_comparison(self):
        ...
        if display_type == "Magnitude":
            ...
            self.plot_widget.plot(np.imag(spectrum), pen=pg.mkPen("gray"), name="Original")
            ...
            if cb.isChecked():
                ...
                if corrected is not None:
                    if display_type == "Magnitude":
                        ...
                        self.plot_widget.plot(np.imag(corrected), pen=color, name=method)
                color_idx += 1
...
class DenoiseComparisonSettingsWindow(QWidget):
    def __init__(self, data, apply_denoising_func):
        ...
        self.methods = ["Mean Filter", "Median Filter", "Gaussian Filter", 
                        ...
                        "Total Variation", "Wiener Filter"]
                        #"UNet Model","Transform Model"]
        self.method_blocks = []
